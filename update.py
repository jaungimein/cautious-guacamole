...
if len(UPSTREAM_REPO) == 0:
    UPSTREAM_REPO = "https://github.com/jaungimein/cautious-guacamole"
...
update = srun([f"git init -q \
                 && git config --global user.email itsherchoice101.0@gmail.com \
                 && git config --global user.name jaungimein \
                 && git add . \
